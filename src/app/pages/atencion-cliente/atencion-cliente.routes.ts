...
export const atencionClienteRoutes: Routes = [
  ...
  { path: 'bandeja-pedidos-historico', loadComponent: () => import('./bandeja-pedidos-historico/bandeja-pedidos-historico.component').then(m => m.BandejaPedidosHistoricoComponent), canActivate: [AuthGuard], data: { roles: [1, 5, 11] } },
  ...
  // Rutas del módulo de devoluciones (solo administrador y atención al cliente)
  { path: 'devoluciones', loadComponent: () => import('./devoluciones/bandeja-devoluciones.component').then(m => m.BandejaDevolucionesComponent), canActivate: [AuthGuard], data: { roles: [1, 11] } },
  { path: 'devoluciones/crear', loadComponent: () => import('./devoluciones/crear-editar-devolucion.component').then(m => m.CrearEditarDevolucionComponent), canActivate: [AuthGuard], data: { roles: [1, 11] } },
  { path: 'devoluciones/editar/:id', loadComponent: () => import('./devoluciones/crear-editar-devolucion.component').then(m => m.CrearEditarDevolucionComponent), canActivate: [AuthGuard], data: { roles: [1, 11] } },
  { path: 'devoluciones/detalle/:id', loadComponent: () => import('./devoluciones/detalle-devolucion.component').then(m => m.DetalleDevolucionComponent), canActivate: [AuthGuard], data: { roles: [1, 11] } },
