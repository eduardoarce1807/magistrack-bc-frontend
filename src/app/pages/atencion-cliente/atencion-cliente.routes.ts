...
export const atencionClienteRoutes: Routes = [
  ...
  { path: 'bandeja-pedidos-historico', loadComponent: () => import('./bandeja-pedidos-historico/bandeja-pedidos-historico.component').then(m => m.BandejaPedidosHistoricoComponent), canActivate: [AuthGuard], data: { roles: [1, 5] } },
