...
import {proveedorReq} from "../../../../model/ordencompraModel";

@Component({
  selector: 'app-reporte-comparativo-precios',
  standalone: true,
  ...
  templateUrl: './reporte-comparativo-precios.component.html',
  styleUrl: './reporte-comparativo-precios.component.scss',
	providers: [MessageService,DialogService ],
	encapsulation: ViewEncapsulation.None,
})
export class ReporteComparativoPreciosComponent {
	page = 1;
	pageSize = 4;
	collectionSize = 0;
	...
	cargarproveedores(){
		...
		this.ordenService.getProveedoresxRequerimiento(this.fila_select.id_requerimiento!).subscribe({
			next:(data)=>{
				this.listProveedores=data.data
