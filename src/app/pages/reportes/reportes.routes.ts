...
export const reportesRoutes: Routes = [
  ...
  { path: 'orden-compra-periodo', loadComponent: () => import('./compras/orden-compra-periodo/orden-compra-periodo.component').then(m => m.OrdenCompraPeriodoComponent), canActivate: [AuthGuard], data: { roles: [1, 5] } },
  { path: 'comparativo-precio', loadComponent: () => import('./compras/reporte-comparativo-precios/reporte-comparativo-precios.component').then(m => m.ReporteComparativoPreciosComponent), canActivate: [AuthGuard], data: { roles: [1, 5] } },
  { path: 'proveedor-ranking', loadComponent: () => import('./compras/reporte-proveedores-ranking/reporte-proveedores-ranking.component').then(m => m.ReporteProveedoresRankingComponent), canActivate: [AuthGuard], data: { roles: [1, 5] } },
  { path: 'comparativo-stock', loadComponent: () => import('./inventario/reporte-comparativo-stock/reporte-comparativo-stock.component').then(m => m.ReporteComparativoStockComponent), canActivate: [AuthGuard], data: { roles: [1, 5] } },
  { path: 'entradas-salidas', loadComponent: () => import('./inventario/reporte-entradas-salidas/reporte-entradas-salidas.component').then(m => m.ReporteEntradasSalidasComponent), canActivate: [AuthGuard], data: { roles: [1, 5] } },
  { path: 'reporte-valorizacion', loadComponent: () => import('./inventario/reporte-valorizacion/reporte-valorizacion.component').then(m => m.ReporteValorizacionComponent), canActivate: [AuthGuard], data: { roles: [1, 5] } },
];
